...
BOT_TOKEN = "7861378620:AAG8L5nJiNpYM7oUpPDL6_OMfq0hNC9drJk"
PAYMENT_CHANNEL = "@rahumod" #add payment channel here including the '@' sign
OWNER_ID = 1918024305 #write owner's user id here.. get it from @MissRose_Bot by /id
CHANNELS = ["@rahumod"] #add channels to be checked here in the format - ["Channel 1", "Channel 2"] 
